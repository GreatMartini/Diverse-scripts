...
#ifndef included_appu_IntegrateDataWriter
#define included_appu_IntegrateDataWriter
...
private:
    ...
    */
   static const float INTEGRAL_DATAWRITER_VERSION_NUMBER;

   /*
    * Static integer constant describing the maximum size of a C char string.
    */
   static const int INTEGRAL_NAME_BUFSIZE;

   /*
    * Static integer constant describing undefined index.
    */
   static const int INTEGRAL_UNDEFINED_INDEX;
    ...
    */
   static const int INTEGRAL_MASTER;
    ...
    */
   enum variable_type { INTEGRAL_SCALAR = 0,
                        INTEGRAL_VECTOR = 1,
                        INTEGRAL_TENSOR = 2 };
    ...
    */
   enum variable_data_type { INTEGRAL_INT = 3,
                             INTEGRAL_FLOAT = 4,
                             INTEGRAL_DOUBLE = 5,
                             INTEGRAL_DATA_TYPE_BAD = 990 };
    ...
    */
   enum variable_centering { INTEGRAL_CELL = 6,
                             INTEGRAL_NODE = 7,
                             INTEGRAL_UNKNOWN_CELL = 8,
                             INTEGRAL_UNKNOWN_NODE = 9,
                             INTEGRAL_CENTERING_BAD = 991 };
    ...
    */
   enum grid_type { INTEGRAL_CARTESIAN = 10,
                    INTEGRAL_DEFORMED = 11 };
   ...
   struct VisItItem {
      ...
      std::vector<double> d_integral_value;
      std::vector<double> d_l2norm_value;
      std::vector<double> d_min_value;
      std::vector<double> d_max_value;
      std::vector<double> d_absmin_value;
      std::vector<double> d_absmax_value;

   };

    std::vector<std::string> d_calculation;
   ...
   initializeCallback()
   {
      t_write_plot_data = tbox::TimerManager::getManager()->getTimer(
         "appu:IntegrateDataWriter::writePlotData()");
   }
